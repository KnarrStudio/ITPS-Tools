...
Function Remove-COOPs{
   ...
   $null = Read-Host -Prompt 'Enter the date of the COOP you want to remove (YYYYMMDD) '
...
Write-Host -sep $NewLine "Preparing to remove ALL COOP'ed vm servers below." $VMSvr -foreground Red
