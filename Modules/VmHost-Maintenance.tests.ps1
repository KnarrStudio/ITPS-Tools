...
# describes the function Script:Switch-Safety
Describe 'Script:Switch-Safety' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Script:Switch-Safety } | Should Not Throw
    }
    It 'does something' {
      # call function Script:Switch-Safety and pipe the result to an assertion
      # Example:
      # Script:Switch-Safety | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Script:Switch-Safety | Should BeNullOrEmpty 
    }
  }
}
